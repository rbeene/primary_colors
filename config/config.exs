...
config :alexa_demo,
  ecto_repos: [AlexaDemo.Repo]

# Configures the endpoint
config :alexa_demo, AlexaDemo.Web.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "4AsVQmKumE1erRz3Nt8JqqN1gwCZzJJkZlPiGOnRlvnGdkMJ5VGs53QmYHczu7Ob",
  render_errors: [view: AlexaDemo.Web.ErrorView, accepts: ~w(html json)],
  pubsub: [name: AlexaDemo.PubSub,
